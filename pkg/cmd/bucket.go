...
func NewBucketCmd() *cobra.Command {
	...
	cmd.AddCommand(CreateBucketCmd(), RemoveBucketCmd(), CorsCmd(), LifecycleCmd(), PolicyCmd(), EventCmd(), EncryptionCmd(), VersioningCmd())
	return cmd
}
...
func LifecycleCmd() *cobra.Command {
	...
	lifecyCmd.AddCommand(SetLifecycleSetCmd(), LifecycleGetCmd(), LifecycleDelCmd())
	return lifecyCmd
}
