...
// respecting the configured output format.
func MpuLocalList(opt MpuLocalOptions) error {
...
// MpuLocalClear removes one local resumable multipart state and prints the
// result respecting the configured output format.
func MpuLocalClear(path string, opt MpuLocalOptions) error {
