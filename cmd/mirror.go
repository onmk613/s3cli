...
func NewCpCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: NewRunETwoPaths(func(src, dst action.Action, srcPath, dstPath *s3path.Path, opts *Context) error {
...
func NewMirrorCmd() *cobra.Command {
	...
	cmd = &cobra.Command{
		...
		Args:              cobra.ExactArgs(2),
		ValidArgsFunction: AutoCompletePath,
		RunE: NewRunETwoPaths(func(src, tgt action.Action, srcPath, tgtPath *s3path.Path, opts *Context) error {
